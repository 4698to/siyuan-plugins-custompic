...
![插件设置截图](https://github.com/4698to/siyuan-plugins-custompic/blob/main/img/image.png)
...
- 指向本仓库自带的 **Flask 后端**（`backend/`，见 [backend/README.md](https://github.com/4698to/siyuan-plugins-custompic/blob/main/backend/README.md)）时，接口约定如下。以下路径均相对于 baseURL，例如 baseURL 为 `http://192.168.1.2:5000` 时，完整 URL 为 `http://192.168.1.2:5000/api/...`。
...
环境变量、监听地址、防火墙与目录结构详见 **[backend/README.md](https://github.com/4698to/siyuan-plugins-custompic/blob/main/backend/README.md)**。
